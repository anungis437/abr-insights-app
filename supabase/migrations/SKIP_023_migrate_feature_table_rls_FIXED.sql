...
DROP POLICY IF EXISTS "enrollments_service_role_bypass" ON enrollments;
...
CREATE POLICY "enrollments_service_role_bypass"
    ON enrollments USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "modules_service_role_bypass" ON course_modules;
...
CREATE POLICY "modules_service_role_bypass"
    ON course_modules USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "progress_service_role_bypass" ON lesson_progress;
...
CREATE POLICY "progress_service_role_bypass"
    ON lesson_progress USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "attempts_service_role_bypass" ON quiz_attempts;
...
CREATE POLICY "attempts_service_role_bypass"
    ON quiz_attempts USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "questions_service_role_bypass" ON questions;
...
CREATE POLICY "questions_service_role_bypass"
    ON questions USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "responses_service_role_bypass" ON quiz_responses;
...
CREATE POLICY "responses_service_role_bypass"
    ON quiz_responses USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "achievements_service_role_bypass" ON course_achievements;
...
CREATE POLICY "achievements_service_role_bypass"
    ON course_achievements USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "user_achievements_service_role_bypass" ON user_course_achievements;
...
CREATE POLICY "user_achievements_service_role_bypass"
    ON user_course_achievements USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "achievement_progress_service_role_bypass" ON course_achievement_progress;
...
CREATE POLICY "achievement_progress_service_role_bypass"
    ON course_achievement_progress USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "streaks_service_role_bypass" ON course_user_streaks;
...
CREATE POLICY "streaks_service_role_bypass"
    ON course_user_streaks USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "points_service_role_bypass" ON user_course_points;
...
CREATE POLICY "points_service_role_bypass"
    ON user_course_points USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "transactions_service_role_bypass" ON course_points_transactions;
...
CREATE POLICY "transactions_service_role_bypass"
    ON course_points_transactions USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "leaderboards_service_role_bypass" ON course_leaderboards;
...
CREATE POLICY "leaderboards_service_role_bypass"
    ON course_leaderboards USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "leaderboard_entries_service_role_bypass" ON course_leaderboard_entries;
...
CREATE POLICY "leaderboard_entries_service_role_bypass"
    ON course_leaderboard_entries USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "groups_service_role_bypass" ON course_study_groups;
...
CREATE POLICY "groups_service_role_bypass"
    ON course_study_groups USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "group_members_service_role_bypass" ON course_study_group_members;
...
CREATE POLICY "group_members_service_role_bypass"
    ON course_study_group_members USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "follows_service_role_bypass" ON course_user_follows;
...
CREATE POLICY "follows_service_role_bypass"
    ON course_user_follows USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "reviews_service_role_bypass" ON course_peer_reviews;
...
CREATE POLICY "reviews_service_role_bypass"
    ON course_peer_reviews USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "paths_service_role_bypass" ON learning_paths;
...
CREATE POLICY "paths_service_role_bypass"
    ON learning_paths USING (auth.jwt()->>'role' = 'service_role');
...
DROP POLICY IF EXISTS "path_enrollments_service_role_bypass" ON learning_path_enrollments;
...
CREATE POLICY "path_enrollments_service_role_bypass"
    ON learning_path_enrollments USING (auth.jwt()->>'role' = 'service_role');
