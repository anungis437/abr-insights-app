...
-- Service role bypass
CREATE POLICY "profiles_.*_full_access"
    ON profiles FOR ALL
    USING (auth.jwt()->>'role' = '.*');
...
CREATE POLICY "organizations_.*_full_access"
...
CREATE POLICY "user_roles_.*_full_access"
...
CREATE POLICY "lessons_.*_full_access"
    ON lessons FOR ALL
    USING (auth.jwt()->>'role' = '.*');
...
CREATE POLICY "tribunal_cases_.*_full_access"
...
CREATE POLICY "quizzes_.*_full_access"
    ON quizzes FOR ALL
    USING (auth.jwt()->>'role' = '.*');
...
CREATE POLICY "certificates_.*_full_access"
...
CREATE POLICY "audit_logs_.*_full_access"
...
CREATE POLICY "ai_usage_logs_.*_full_access"
