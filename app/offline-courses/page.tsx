...
import { useCourseDownload, useCacheManagement, useOnlineStatus, type DownloadedCourse } from '@/lib/hooks/usePWA'
...
export default function OfflineCoursesPage() {
  ...
  const storageUsagePercent = cacheStatus.quota > 0
    ? (cacheStatus.usage / cacheStatus.quota) * 100
    : 0
      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Courses downloaded for offline learning
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          ...
          {downloadedCourses.length === 0 ? (
            <div className="px-6 py-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No offline courses yet</h3>
                    ...
                    {isDownloadingCourse && (
                      <div className="mt-4">
                        ...
                        <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                          <div className="h-full bg-blue-500 transition-all duration-300 w-full animate-pulse" />
                        </div>
                      </div>
                    )}
                  </div>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-xl p-6">
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-semibold text-blue-900 mb-2">About Offline Learning</h3>
