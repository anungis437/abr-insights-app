          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-12">
              ...
              <p className="mb-4 text-gray-700">
                ...
                widely used to make websites work more efficiently, provide a better user experience, and provide 
                information to website owners.
              </p>
              <p className="text-gray-700">
                ABR Insights uses cookies and similar technologies (such as web beacons, pixels, and local storage) 
                to recognize you, remember your preferences, and provide you with a personalized experience.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="mb-8 rounded-lg border-2 border-green-200 bg-green-50 p-6">
                <h3 className="mb-2 text-lg font-semibold text-green-900">Strictly Necessary Cookies</h3>
                ...
                <ul className="list-disc space-y-1 pl-6 text-sm text-green-800">
                  ...
                  <li><strong>Security cookies:</strong> Enable security features and protect against fraud</li>
                  <li><strong>Load balancing:</strong> Distribute traffic across servers for performance</li>
                </ul>
                <p className="mt-3 text-xs font-medium text-green-900">Duration: Session or up to 30 days</p>
              </div>
              ...
              <div className="mb-8 rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
                ...
                <ul className="list-disc space-y-1 pl-6 text-sm text-blue-800">
                  <li><strong>Preference cookies:</strong> Remember your language, timezone, and display preferences</li>
                  <li><strong>Progress tracking:</strong> Save your course progress and bookmarks</li>
                  <li><strong>Form data:</strong> Remember previously entered information</li>
                  <li><strong>Video player settings:</strong> Remember playback speed and caption preferences</li>
                </ul>
              ...
              <div className="mb-8 rounded-lg border-2 border-purple-200 bg-purple-50 p-6">
                ...
                <ul className="list-disc space-y-1 pl-6 text-sm text-purple-800">
                  <li><strong>Usage analytics:</strong> Track pages visited, time spent, and features used</li>
                  <li><strong>Performance monitoring:</strong> Measure page load times and technical issues</li>
                  <li><strong>A/B testing:</strong> Test different versions of features to improve user experience</li>
                  <li><strong>Conversion tracking:</strong> Measure signup and subscription completion rates</li>
                </ul>
                <p className="mt-3 text-xs font-medium text-purple-900">Duration: Up to 2 years | Provider: Azure Application Insights</p>
              </div>
              ...
              <div className="mb-8 rounded-lg border-2 border-orange-200 bg-orange-50 p-6">
                ...
                <p className="mb-3 text-sm text-orange-800">
                  These cookies track your browsing habits to deliver relevant advertising (opt-in required).
                </p>
                <ul className="list-disc space-y-1 pl-6 text-sm text-orange-800">
                  <li><strong>Advertising cookies:</strong> Track effectiveness of marketing campaigns</li>
                  <li><strong>Retargeting:</strong> Show relevant ads based on pages you&apos;ve visited</li>
                  <li><strong>Social media:</strong> Enable sharing content to social platforms</li>
                </ul>
                <p className="mt-3 text-xs font-medium text-orange-900">Duration: Up to 1 year | Providers: LinkedIn, Google Ads</p>
              </div>
            </section>
                ...
                <table className="w-full border-collapse border border-gray-300 text-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 px-4 py-2">Cross-site request forgery protection</td>
                      <td className="border border-gray-300 px-4 py-2">Session</td>
                      <td className="border border-gray-300 px-4 py-2">Necessary</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 px-4 py-2 font-mono">user-preferences</td>
                      <td className="border border-gray-300 px-4 py-2">Language, timezone, theme preferences</td>
                      <td className="border border-gray-300 px-4 py-2">1 year</td>
                      <td className="border border-gray-300 px-4 py-2">Functional</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 px-4 py-2 font-mono">course-progress</td>
                      <td className="border border-gray-300 px-4 py-2">Track lesson completion and bookmarks</td>
                      <td className="border border-gray-300 px-4 py-2">1 year</td>
                      <td className="border border-gray-300 px-4 py-2">Functional</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 px-4 py-2">Application Insights session tracking</td>
            ...
            <section className="mb-12">
              ...
              <p className="mb-4 text-gray-700">
                When you first visit ABR Insights, you&apos;ll see a cookie consent banner. You can choose to:
              </p>
              <ul className="mb-6 list-disc space-y-2 pl-6 text-gray-700">
                <li><strong>Accept All:</strong> Allow all cookies for optimal functionality and personalization</li>
                <li><strong>Reject Non-Essential:</strong> Only use strictly necessary cookies (may limit functionality)</li>
              ...
              <ul className="list-disc space-y-2 pl-6 text-gray-700">
                ...
                <li><a href="https://support.mozilla.org/en-US/kb/clear-cookies-and-site-data-firefox" className="text-primary-600 hover:text-primary-700" target="_blank" rel="noopener noreferrer">Mozilla Firefox</a></li>
                <li><a href="https://support.apple.com/guide/safari/manage-cookies-sfri11471/mac" className="text-primary-600 hover:text-primary-700" target="_blank" rel="noopener noreferrer">Safari</a></li>
            ...
            <section className="mb-12">
              ...
              <ul className="mb-6 list-disc space-y-2 pl-6 text-gray-700">
                ...
                <li><strong>Azure Application Insights:</strong> Performance monitoring and analytics</li>
                <li><strong>SendGrid:</strong> Email delivery tracking</li>
              </ul>
              <p className="text-gray-700">
                These third parties have their own privacy policies and cookie policies. We recommend reviewing 
                their policies for detailed information about their cookie practices.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700">
                Some browsers include a &quot;Do Not Track&quot; (DNT) feature that signals websites you do not want to be 
                tracked. Currently, there is no industry standard for how to respond to DNT signals. ABR Insights 
                does not currently respond to DNT browser signals, but you can control cookies through our consent 
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700">
                We may update this Cookie Policy to reflect changes in our practices or for legal, operational, 
                or regulatory reasons. We will notify you of significant changes by updating the &quot;Last updated&quot; 
                date and, if necessary, displaying a prominent notice on our website.
              </p>
            </section>
