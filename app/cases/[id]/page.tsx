  ...
  try {
    ...
    return {
      ...
      classifications: [
        ...
        {
          category: 'Confidence',
          value: `${Math.round((caseData.combined_confidence || 0) * 100)}%`,
        },
      ...
      impact: {
        individual:
          aiClass.reasoning || ruleBasedClass.reasoning || 'Impact assessment not available.',
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-3">
                  <div
                    className={`inline-flex items-center gap-2 rounded-lg border px-3 py-1 text-sm font-medium ${getSeverityColor(caseStudy.severity)}`}
                  >
                    <AlertTriangle className="h-4 w-4" />
                    {caseStudy.severity} Severity
                  </div>
                  <div
                    className={`inline-flex items-center gap-2 rounded-lg border px-3 py-1 text-sm font-medium ${getOutcomeColor(caseStudy.outcome)}`}
                  >
                ...
                <Tabs defaultValue="overview" className="w-full">
                  ...
                  <TabsContent value="overview" className="space-y-6">
                    <div className="rounded-2xl border border-gray-200 bg-white p-8">
                      ...
                      <p className="leading-relaxed text-gray-700">{caseStudy.summary}</p>
                    </div>
                  ...
                  <TabsContent value="timeline">
                    <div className="rounded-2xl border border-gray-200 bg-white p-8">
                      ...
                      <div className="relative space-y-6">
                        {/* Timeline line */}
                        <div className="absolute bottom-2 left-4 top-2 w-0.5 bg-gray-200"></div>
              ...
              <div className="lg:col-span-1">
                ...
                {caseStudy.relatedCases && caseStudy.relatedCases.length > 0 && (
                  <div className="rounded-2xl border border-gray-200 bg-white p-6">
                    ...
                    <Link
                      href="/cases"
                      className="mt-4 inline-flex w-full items-center justify-center gap-2 text-sm font-medium text-primary-600 hover:text-primary-700"
                    >
                      Explore more cases
                    </Link>
                  </div>
