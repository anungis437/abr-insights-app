...
import { BookOpen, Award, FileText, Search, ChevronRight } from 'lucide-react'
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="space-y-2">
                  <Link
                    href="/cases/browse"
                    className="flex items-center justify-between rounded-lg border border-gray-100 p-3 text-gray-700 transition-colors hover:bg-gray-50"
                  >
