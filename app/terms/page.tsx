          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-12">
              ...
              <p className="mb-4 text-gray-700">
                These Terms of Service (&quot;Terms&quot;) constitute a legally binding agreement between you and ABR Insights 
                (&quot;Company,&quot; &quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) regarding your access to and use of the ABR Insights platform, 
                website, courses, case database, and related services (collectively, the &quot;Services&quot;).
              </p>
            ...
            <section className="mb-12">
              <h2 className="mb-4 text-2xl font-bold text-gray-900">Account Registration and Security</h2>
            ...
            <section className="mb-12">
              <h2 className="mb-4 text-2xl font-bold text-gray-900">Subscription Plans and Billing</h2>
              ...
              <ul className="mb-6 list-disc space-y-2 pl-6 text-gray-700">
                <li><strong>Free Tier:</strong> Limited access to select courses and case search features</li>
                <li><strong>Professional Tier:</strong> Full access to all courses, AI-powered search, and analytics (billed monthly or annually)</li>
                <li><strong>Enterprise Tier:</strong> Custom pricing with team management, advanced analytics, and dedicated support</li>
              </ul>
              ...
              <ul className="mb-6 list-disc space-y-2 pl-6 text-gray-700">
                ...
                <li>30-day money-back guarantee for first-time annual subscriptions (within first 30 days)</li>
                <li>Enterprise contracts are subject to specific cancellation terms in the agreement</li>
              </ul>

              <h3 className="mb-3 text-xl font-semibold text-gray-800">Failed Payments</h3>
              <p className="text-gray-700">
                If payment fails, we will attempt to charge your payment method up to three times. If payment 
                remains unsuccessful, your account may be downgraded to the Free tier and access to paid features 
                will be suspended until payment is resolved.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="mb-4 text-gray-700">
                All content on the Services, including courses, case analyses, software, text, graphics, logos, 
                images, and data compilations, is owned by ABR Insights or its licensors and is protected by 
              ...
              <p className="mb-4 text-gray-700">
                ...
                Services for your personal or internal business use, subject to these Terms.
              </p>

              <h3 className="mb-3 text-xl font-semibold text-gray-800">Tribunal Decisions</h3>
              <p className="mb-4 text-gray-700">
                Tribunal decisions are public domain materials. Our value-added content (AI analysis, classifications, 
                summaries, and organizational structure) is proprietary and protected by intellectual property rights.
              </p>

              <h3 className="mb-3 text-xl font-semibold text-gray-800">User Content</h3>
              <p className="text-gray-700">
                You retain ownership of any content you submit (e.g., comments, feedback). By submitting content, 
                you grant us a worldwide, non-exclusive, royalty-free license to use, reproduce, modify, and display 
                such content in connection with operating and improving the Services.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="mb-6 rounded-lg border-2 border-yellow-300 bg-yellow-50 p-6">
                ...
                <p className="text-sm text-yellow-800">
                  ABR Insights provides educational content and case analysis tools. We do not provide legal advice. 
              ...
              <h3 className="mb-3 text-xl font-semibold text-gray-800">Service &quot;As Is&quot;</h3>
              <p className="mb-4 text-gray-700">
              ...
              <p className="text-gray-700">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, ABR INSIGHTS AND ITS AFFILIATES, OFFICERS, DIRECTORS, 
                EMPLOYEES, AND AGENTS SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, 
                OR PUNITIVE DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR GOODWILL, ARISING OUT OF OR RELATED TO 
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700">
                You agree to indemnify, defend, and hold harmless ABR Insights and its affiliates from any claims, 
                liabilities, damages, losses, and expenses (including legal fees) arising out of or related to:
                (a) your violation of these Terms, (b) your use of the Services, (c) your content, or 
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700">
                ...
                nature should survive termination (including intellectual property rights, disclaimers, and 
                limitations of liability) will survive.
              </p>
            </section>

            <section className="mb-12">
              <h2 className="mb-4 text-2xl font-bold text-gray-900">Governing Law and Dispute Resolution</h2>
              ...
              <p className="mb-4 text-gray-700">
                Before initiating litigation, you agree to first contact us at <a href="mailto:legal@abrinsights.ca" className="text-primary-600 hover:text-primary-700">legal@abrinsights.ca</a> to 
                attempt to resolve the dispute informally. If the dispute cannot be resolved within 60 days:
              </p>
              <ul className="list-disc space-y-2 pl-6 text-gray-700">
                <li>For disputes under $25,000 CAD: Binding arbitration in Toronto, Ontario under the Arbitration Act, 1991 (Ontario)</li>
            ...
            <section className="mb-12">
              ...
              <p className="mb-4 text-gray-700">
                These Terms, together with our Privacy Policy and any additional terms specific to certain features, 
                constitute the entire agreement between you and ABR Insights.
              </p>
            ...
            <section className="mb-12">
              ...
              <div className="rounded-lg bg-gray-50 p-6">
                ...
                <p className="text-gray-700">
                  ...
                  Canada<br />
                  <a href="mailto:legal@abrinsights.ca" className="text-primary-600 hover:text-primary-700">legal@abrinsights.ca</a>
                </p>
              </div>
            </section>
          </div>
