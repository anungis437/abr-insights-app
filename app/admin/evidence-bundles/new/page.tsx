...
import {
  Package, FileText, BookOpen, Shield, Award, ClipboardCheck,
  Plus, Save, CheckCircle, AlertCircle, ArrowRight, X
} from 'lucide-react'
...
export default function EvidenceBundleBuilderPage() {
  ...
  const [bundleType, setBundleType] = useState<EvidenceBundleMetadata['bundle_type']>('incident_response')
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Evidence Bundle Builder</h1>
      ...
      {step === 1 && (
        <div className="bg-white rounded-lg shadow p-8">
          <h2 className="text-xl font-semibold mb-6">Bundle Information</h2>
      ...
      {step === 2 && (
        <div className="bg-white rounded-lg shadow p-8">
          <h2 className="text-xl font-semibold mb-6">Add Evidence Components</h2>
          ...
          <div className="mb-8">
            <h3 className="font-semibold mb-4">Selected Components ({selectedComponents.length})</h3>
                    ...
                    <div className="flex items-center gap-3">
                      {componentTypes.find(t => t.value === component.type)?.icon && (
                        <div className="p-2 bg-blue-50 rounded">
                          {(() => {
                            const Icon = componentTypes.find(t => t.value === component.type)!.icon
      ...
      {step === 3 && (
        <div className="bg-white rounded-lg shadow p-8">
          <h2 className="text-xl font-semibold mb-6">Policy Mappings</h2>
          ...
          <div className="mb-8">
            ...
            {policyMappings.length > 0 && (
              <div className="mb-6">
                <h3 className="font-semibold mb-3">Suggested Mappings</h3>
                <div className="space-y-3">
                  {policyMappings.map((mapping, index) => (
                    <div key={index} className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                      <div className="font-medium text-blue-900 mb-2">
                        {mapping.policy_title}
                      </div>
            ...
            <div className="p-4 border-2 border-dashed border-gray-300 rounded-lg">
              <h3 className="font-semibold mb-4">Add Custom Mapping</h3>
              <div className="grid grid-cols-2 gap-4">
                <input
                  type="text"
                  placeholder="Policy Reference"
                  value={newMapping.policy_reference || ''}
                  onChange={(e) => setNewMapping({...newMapping, policy_reference: e.target.value})}
                ...
                <textarea
                  ...
                  onChange={(e) => setNewMapping({...newMapping, mapping_rationale: e.target.value})}
      ...
      {step === 4 && (
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <div className="space-y-6 mb-8">
            ...
            <div>
              <h3 className="font-semibold mb-2">Policy Mappings</h3>
            ...
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              ...
              <p className="text-sm text-green-600">
                Your evidence bundle will be finalized and a chronological timeline will be generated automatically.
              </p>
            </div>
          </div>
