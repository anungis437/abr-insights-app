...
export default function HomePage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        const { data: courses } = await coursesService.list({ is_published: true }, { limit: 3 })
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary-600 to-secondary-600 py-20 text-white">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="text-center lg:text-left">
              ...
              <p className="mb-8 text-xl text-gray-100 md:text-2xl">
                Comprehensive training, real-world case studies, and actionable insights for
        ...
        <div className="absolute left-0 top-0 -z-10 h-full w-full opacity-10">
          ...
          <div className="absolute bottom-1/4 right-1/4 h-96 w-96 rounded-full bg-yellow-300 blur-3xl" />
        </div>
      </section>
      {/* Features Section */}
        ...
        <div className="container-custom">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-xl text-gray-600">
              Comprehensive tools and resources designed for organizations committed to meaningful
              change
            </p>
          </div>
        ...
        <section className="py-20">
          <div className="container-custom">
            <div className="mb-12 text-center">
              <h2 className="mb-4 text-4xl font-bold text-gray-900">Featured Training Courses</h2>
              <p className="mx-auto max-w-2xl text-xl text-gray-600">
      ...
      <section className="py-20">
        <div className="container-custom">
          <div className="rounded-2xl bg-gradient-to-r from-primary-600 to-secondary-600 p-12 text-center text-white shadow-2xl">
            <h2 className="mb-4 text-4xl font-bold">Ready to Create Real Change?</h2>
...
function CourseCard({ course }: { course: Course }) {
  ...
  return (
    <Link href={`/courses/${course.slug}`} className="card group transition-shadow hover:shadow-xl">
      ...
      {course.description && (
        <p className="mb-4 line-clamp-3 text-sm text-gray-600">{course.description}</p>
      )}
