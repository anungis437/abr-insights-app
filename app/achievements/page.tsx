              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-gray-900">
                    {userPoints.course_points} pts
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Engagement</span>
                  <span className="font-semibold text-gray-900">
                    {userPoints.engagement_points} pts
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Achievements</span>
                  <span className="font-semibold text-gray-900">
                    {userPoints.achievement_points} pts
                  </span>
                </div>
                <div className="flex items-center justify-between">
                ...
                return (
                  <div
                    ...
                    className={`rounded-lg border-2 p-6 transition-all ${
                      isEarned ? `${rarityColors} shadow-md` : 'border-gray-200 bg-white opacity-60'
                    }`}
                  >
                    <div className="mb-4 flex items-start justify-between">
                      ...
                      <div className="text-right">
                        <span
                          className={`inline-block rounded-full px-2 py-1 text-xs font-semibold uppercase ${rarityColors}`}
                        >
                          {achievement.rarity}
                        </span>
                      </div>
              ...
              <div className="space-y-3">
                {userAchievements.slice(0, 5).map((ua) => (
                  <div key={ua.id} className="flex items-center gap-4 rounded-lg border p-3">
                    <div
                      className={`flex h-10 w-10 items-center justify-center rounded-lg ${getRarityColor(ua.achievement.rarity)}`}
                    >
