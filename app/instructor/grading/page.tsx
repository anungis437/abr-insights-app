      ...
      <div className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="rounded-lg border-2 border-dashed border-gray-300 bg-white p-12 text-center">
            ...
            <h3 className="mb-2 text-lg font-semibold text-gray-900">Grading System</h3>
            <p className="text-gray-600">
              Grading and assessment features are coming soon. You&apos;ll be able to review quiz
              results, grade assignments, and provide feedback.
            </p>
          </div>
        </div>
      </div>
