...
export default function AIAssistantPage() {
  ...
  const { hasFeature, loading: isCheckingAccess } = useEntitlements()
  const hasAccess = hasFeature('aiAssistantAccess')
            ...
            <div className="lg:col-span-2">
              <div className="flex h-[700px] flex-col rounded-lg border border-gray-200 bg-white shadow-sm">
                ...
                <div className="flex-1 space-y-4 overflow-y-auto p-6">
                  {/* AI Disclaimer (P1 Liability Protection) */}
                  {messages.length === 0 && (
                    <div className="mb-4">
                      <AIDisclaimer
                        variant="chat"
                        persistenceKey="ai-assistant-disclaimer"
