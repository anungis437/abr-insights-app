          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-12">
              ...
              <p className="mb-4 text-gray-700">
                At ABR Insights, we implement industry-leading security practices to protect your data. Our 
                comprehensive security program encompasses technical, administrative, and physical safeguards 
                designed to prevent unauthorized access, disclosure, alteration, or destruction of your information.
              </p>
              <p className="text-gray-700">
                We maintain compliance with relevant security standards and undergo regular third-party security 
                audits to ensure our practices meet or exceed industry benchmarks.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="rounded-lg border-2 border-green-200 bg-green-50 p-6">
                  ...
                  <ul className="space-y-1 text-sm text-gray-700">
                    <li><strong>MFA:</strong> Multi-factor authentication for all accounts</li>
                    <li><strong>RBAC:</strong> Role-based access control with principle of least privilege</li>
                ...
                <div className="rounded-lg border-2 border-purple-200 bg-purple-50 p-6">
                  ...
                  <h3 className="mb-2 text-lg font-semibold text-gray-900">Infrastructure Security</h3>
                  <ul className="space-y-1 text-sm text-gray-700">
                    <li><strong>Cloud Provider:</strong> Microsoft Azure with SOC 2 Type II certification</li>
                    <li><strong>DDoS Protection:</strong> Azure DDoS Protection Standard</li>
                    <li><strong>Firewalls:</strong> Network segmentation and WAF protection</li>
                  </ul>
                </div>
                ...
                <div className="rounded-lg border-2 border-orange-200 bg-orange-50 p-6">
                  ...
                  <ul className="space-y-1 text-sm text-gray-700">
                    <li><strong>SIEM:</strong> 24/7 security monitoring and alerting</li>
                    <li><strong>Intrusion Detection:</strong> Real-time threat detection systems</li>
                    <li><strong>Vulnerability Scanning:</strong> Weekly automated security scans</li>
                  </ul>
                </div>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <h3 className="mb-3 text-xl font-semibold text-gray-800">Secure Development Lifecycle</h3>
              <p className="mb-4 text-gray-700">Our development process incorporates security at every stage:</p>
              <ul className="mb-6 list-disc space-y-2 pl-6 text-gray-700">
                <li><strong>Code Review:</strong> All code changes undergo peer review before deployment</li>
                <li><strong>Static Analysis:</strong> Automated security scanning with Snyk and SonarQube</li>
                <li><strong>Dependency Management:</strong> Regular updates and vulnerability monitoring</li>
                <li><strong>Penetration Testing:</strong> Annual third-party penetration testing</li>
                <li><strong>Security Training:</strong> Mandatory security awareness training for all developers</li>
              </ul>

              <h3 className="mb-3 text-xl font-semibold text-gray-800">Authentication & Session Management</h3>
              <ul className="mb-6 list-disc space-y-2 pl-6 text-gray-700">
              ...
              <h3 className="mb-3 text-xl font-semibold text-gray-800">Protection Against Common Threats</h3>
              <ul className="list-disc space-y-2 pl-6 text-gray-700">
                <li><strong>SQL Injection:</strong> Parameterized queries and ORM usage</li>
                <li><strong>XSS:</strong> Input validation and output encoding</li>
                <li><strong>CSRF:</strong> Token-based CSRF protection on all state-changing operations</li>
            ...
            <section className="mb-12">
              ...
              <p className="mb-4 text-gray-700">
                We collect only the data necessary to provide our Services. Personal information is not shared 
                with third parties except as required to deliver the Services or as required by law.
              </p>

              <h3 className="mb-3 text-xl font-semibold text-gray-800">Data Isolation</h3>
              <p className="mb-4 text-gray-700">
                Customer data is logically isolated using Row Level Security (RLS) policies in our database. 
                Multi-tenant architecture ensures data cannot be accessed across organizational boundaries.
              </p>

              <h3 className="mb-3 text-xl font-semibold text-gray-800">Data Residency</h3>
              <p className="mb-4 text-gray-700">
                All customer data is stored in Canadian data centers (Azure Canada Central and Canada East regions). 
                Data does not leave Canada except:
              </p>
              <ul className="list-disc space-y-2 pl-6 text-gray-700">
            ...
            <section className="mb-12">
              <h2 className="mb-4 text-2xl font-bold text-gray-900">Business Continuity & Disaster Recovery</h2>
              
              <h3 className="mb-3 text-xl font-semibold text-gray-800">Backups</h3>
              <ul className="mb-6 list-disc space-y-2 pl-6 text-gray-700">
                <li><strong>Frequency:</strong> Automated daily backups with point-in-time recovery</li>
                <li><strong>Retention:</strong> 30-day backup retention for production data</li>
                <li><strong>Testing:</strong> Quarterly backup restoration tests</li>
              ...
              <p className="mb-4 text-gray-700">
                We maintain a comprehensive incident response plan with defined procedures for detecting, 
                responding to, and recovering from security incidents. Our team is available 24/7 to respond 
            ...
            <section className="mb-12">
              ...
              <ul className="mb-6 list-disc space-y-2 pl-6 text-gray-700">
                ...
                <li>Principle of least privilege - access granted only as needed for job function</li>
            ...
            <section className="mb-12">
              <h2 className="mb-4 text-2xl font-bold text-gray-900">Vulnerability Disclosure Program</h2>
              <p className="mb-4 text-gray-700">
              ...
              <div className="rounded-lg bg-gray-50 p-6">
                ...
                <p className="mb-3 text-sm text-gray-700">
                  Email: <a href="mailto:security@abrinsights.ca" className="text-primary-600 hover:text-primary-700">security@abrinsights.ca</a>
                </p>
                <p className="mb-4 text-sm text-gray-700">
                  Please include detailed steps to reproduce the issue and any relevant screenshots or proof of concept.
                </p>
            ...
            <section className="mb-12">
              <h2 className="mb-4 text-2xl font-bold text-gray-900">Security Breach Notification</h2>
              <p className="mb-4 text-gray-700">
              ...
              <ul className="list-disc space-y-2 pl-6 text-gray-700">
                ...
                <li>Notification will include the nature of the breach, affected data, and remediation steps</li>
                <li>We will report the breach to relevant regulatory authorities as required by law</li>
                <li>We will provide guidance on how to protect yourself from potential consequences</li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="mt-4 text-gray-700">
                Key third-party services: Microsoft Azure (hosting), Supabase (database), Stripe (payments), 
                SendGrid (email), Azure OpenAI (AI features).
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="rounded-lg bg-gray-50 p-6">
                ...
                <p className="mb-3 text-gray-700">
                  <a href="mailto:security@abrinsights.ca" className="text-primary-600 hover:text-primary-700">security@abrinsights.ca</a>
                </p>
                <p className="text-xs text-gray-600">
                  For general support inquiries, please use <a href="/contact" className="text-primary-600 hover:text-primary-700">our contact form</a>
                </p>
              </div>
            </section>
          </div>
