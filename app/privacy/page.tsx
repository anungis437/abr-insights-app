      ...
      <div className="container-custom px-4 py-24">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-12 text-center">
            ...
            <h1 className="mb-4 text-4xl font-bold text-gray-900 md:text-5xl">Privacy Policy</h1>
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-12">
              ...
              <p className="mb-4 text-gray-700">
                ABR Insights (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to
                protecting your privacy and personal information. This Privacy Policy explains how
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc space-y-2 pl-6 text-gray-700">
                <li>
                  <strong>Provide Services:</strong> Process registrations, deliver courses, track
                  progress, generate certificates
                </li>
                <li>
                  <strong>Personalization:</strong> Recommend relevant courses, customize content,
                  improve user experience
                </li>
                <li>
                  <strong>Communication:</strong> Send updates, notifications, support responses,
                  and educational content
                </li>
                <li>
                  <strong>Analytics:</strong> Analyze usage patterns, improve platform performance,
                  develop new features
                </li>
                <li>
                  <strong>Security:</strong> Detect fraud, prevent abuse, protect user accounts
                </li>
                <li>
                  <strong>Legal Compliance:</strong> Comply with laws, respond to legal requests,
                  enforce our terms
                </li>
                <li>
                  <strong>Research:</strong> Conduct aggregated research on learning outcomes
            ...
            <section className="mb-12">
              ...
              <p className="mb-4 text-gray-700">
                If you are accessing ABR Insights through an organizational account, your employer
                or organization may have access to course enrollment, completion status, quiz
                scores, and usage analytics for reporting and compliance purposes.
              </p>
              ...
              <ul className="list-disc space-y-2 pl-6 text-gray-700">
                ...
                <li>
                  Protect the rights, property, or safety of ABR Insights, our users, or the public
                </li>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc space-y-2 pl-6 text-gray-700">
                <li>
                  <strong>Account data:</strong> Retained while your account is active, plus 7 years
                  after account closure for legal compliance
                </li>
                <li>
                  <strong>Course completion records:</strong> Retained indefinitely for certificate
                  verification purposes
                </li>
                <li>
                  <strong>Payment records:</strong> Retained for 7 years as required by Canadian tax
                  laws
                </li>
                <li>
                  <strong>Usage logs:</strong> Retained for 90 days, then anonymized for analytics
                </li>
                <li>
            ...
            <section className="mb-12">
              ...
              <ul className="mb-6 list-disc space-y-2 pl-6 text-gray-700">
                ...
                <li>
                  <strong>Withdrawal of Consent:</strong> Withdraw consent for certain uses (may
              ...
              <p className="mb-4 text-gray-700">
                ...
                . We will respond to your request within 30 days. You may also update your account
                information directly through your profile settings.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700">
                ...
                may limit your ability to use certain features of our Services. See our{' '}
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700">
                ...
                100% secure. Please use strong passwords and enable two-factor authentication for
                your account.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700">
                Your information may be processed and stored in Canada and other countries where we
                or our service providers operate. We ensure that international transfers comply with
                applicable data protection laws through appropriate safeguards such as standard
                contractual clauses.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="mb-4 text-gray-700">
                ...
                practices, technologies, legal requirements, or other factors. We will notify you of
                material changes by:
              </p>
              <ul className="mb-6 list-disc space-y-2 pl-6 text-gray-700">
