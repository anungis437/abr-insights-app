...
const adminAnalyticsContent = `'use client'
...
const dirPath = path.join(process.cwd(), 'app', 'admin', 'analytics');
if (!fs.existsSync(dirPath)) {
  fs.mkdirSync(dirPath, { recursive: true });
}

const filePath = path.join(dirPath, 'page.tsx');
fs.writeFileSync(filePath, adminAnalyticsContent, 'utf8');

console.log('Admin analytics page written successfully');
