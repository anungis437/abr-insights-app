...
const adminCoursesContent = `'use client'
...
const dirPath = path.join(process.cwd(), 'app', 'admin', 'courses');
if (!fs.existsSync(dirPath)) {
  fs.mkdirSync(dirPath, { recursive: true });
}

const filePath = path.join(dirPath, 'page.tsx');
fs.writeFileSync(filePath, adminCoursesContent, 'utf8');

console.log('Admin courses page written successfully');
