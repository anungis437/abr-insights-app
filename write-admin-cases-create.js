...
const caseCreatePage = `'use client'
...
const outputDir = path.join(__dirname, '..', 'app', 'admin', 'cases', 'create');
fs.mkdirSync(outputDir, { recursive: true });

const outputFile = path.join(outputDir, 'page.tsx');
fs.writeFileSync(outputFile, caseCreatePage);

console.log('✅ Case creation page written to:', outputFile);
