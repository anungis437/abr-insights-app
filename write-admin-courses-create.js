...
const courseCreatePage = `'use client'
...
const outputDir = path.join(__dirname, '..', 'app', 'admin', 'courses', 'create');
fs.mkdirSync(outputDir, { recursive: true });

const outputFile = path.join(outputDir, 'page.tsx');
fs.writeFileSync(outputFile, courseCreatePage);

console.log('✅ Course creation page written to:', outputFile);
