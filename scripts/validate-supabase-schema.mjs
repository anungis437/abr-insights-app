...
async function getTables() {
  ...
  const knownTables = [
    'profiles', 'organizations', 'roles', 'permissions',
    'courses', 'lessons', 'quizzes', 'content_categories',
    'enrollments', 'lesson_progress', 'quiz_attempts',
    'achievements', 'user_achievements', 'bookmarks',
    'tribunal_cases', 'tribunal_cases_raw', 'ingestion_jobs',
    'testimonials', 'newsletter_subscribers',
    'course_reviews', 'learning_streaks', 'user_points'
  ];
...
async function checkProfilesColumns() {
  ...
  const columnsToCheck = [
    ...
    'display_name', 'role', 'organization_id'
  ];
