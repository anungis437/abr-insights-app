...
async function populateHumanRightsLaw() {
  ...
  const { data: course } = await supabase.from('courses').select('id').eq('slug', 'canadian-human-rights-law').single()
  ...
  const m1 = await createModule(course.id, {
    ...
    description: 'Understanding the Canadian Charter of Rights and Freedoms and constitutional protections.',
    sort_order: 1
  })
      ...
      questions: [
        {
          ...
          options: ['All employers in Canada', 'Only federal government and federally-regulated industries', 'Only private companies', 'Provincial governments'],
          correct_answer: 1,
          explanation: 'The CHRA applies to federal government departments/agencies and federally-regulated sectors like banks, telecom, and transportation. Provincial human rights codes cover other employers.'
        },
        {
          question: 'What is the time limit for filing a federal human rights complaint?',
          options: ['30 days', '6 months', '1 year', 'No time limit'],
          correct_answer: 2,
          explanation: 'You must file a complaint within 1 year of the discriminatory incident, though exceptions may apply in certain circumstances.'
        },
        {
          question: 'Maximum compensation for pain and suffering in CHRC cases is:',
          options: ['$10,000', '$20,000', '$50,000', 'No limit'],
          correct_answer: 1,
          explanation: 'The Canadian Human Rights Act sets a cap of $20,000 for pain and suffering, plus up to $20,000 additional for willful or reckless discrimination.'
        }
      ],
...
3. How does Quebec's unique approach reflect its legal tradition?`,
  ...
  await createLesson(course.id, m3.id, {
    ...
    content_data: {
      questions: [
        {
          question: 'Which document provides constitutional protection against discrimination by government?',
          options: ['Canadian Human Rights Act', 'Charter of Rights and Freedoms', 'Provincial human rights codes', 'Employment Standards Act'],
          correct_answer: 1,
          explanation: 'The Charter of Rights and Freedoms (particularly Section 15) provides constitutional protection against government discrimination.'
        },
        {
          question: 'Substantive equality means:',
          options: ['Treating everyone exactly the same', 'Recognizing different needs and circumstances to achieve true equality', 'Equal outcomes for all groups', 'Reverse discrimination'],
          correct_answer: 1,
          explanation: 'Substantive equality recognizes that treating everyone identically may perpetuate inequality. It focuses on eliminating disadvantage and accommodating differences.'
        },
        {
          question: 'A federally-regulated bank employee experiencing racial discrimination should file a complaint with:',
          options: ['Provincial human rights tribunal', 'Canadian Human Rights Commission', 'Employment Standards branch', 'Labour Board'],
          correct_answer: 1,
          explanation: 'Federal employees and those in federally-regulated industries fall under the Canadian Human Rights Act and should file with the CHRC.'
        },
        {
          question: 'In Ontario, a unionized employee experiencing discrimination:',
          options: ['Cannot file a human rights complaint', 'Must pursue only through union grievance', 'Can file at HRTO even if covered by collective agreement', 'Must choose between grievance and HRTO'],
          correct_answer: 2,
          explanation: 'Ontario allows unionized employees to file at HRTO even if the issue is covered by their collective agreement, though the tribunal may defer to arbitration.'
        }
      ],
      passing_score: 80, time_limit_minutes: 20
    },
