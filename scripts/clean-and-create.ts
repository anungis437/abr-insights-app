...
async function cleanDatabase() {
  ...
  const testUsers = [
    ...
    { email: 'educator@abr-insights.com', password: 'TestPass123!', role: 'educator', display_name: 'Test Educator' },
    { email: 'learner@abr-insights.com', password: 'TestPass123!', role: 'learner', display_name: 'Test Learner' },
  ];
