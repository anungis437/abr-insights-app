...
import { generateAllCaseEmbeddings, generateAllCourseEmbeddings } from '../lib/services/embedding-service';
...
async function main() {
  ...
  try {
    ...
    console.log('   - Test search: POST /api/embeddings/search-cases with {"query": "discrimination"}');
    console.log();
