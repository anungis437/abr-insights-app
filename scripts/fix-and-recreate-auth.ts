...
const testAccounts = [
  { email: 'super_admin@abr-insights.com', role: 'super_admin', firstName: 'Super', lastName: 'Admin' },
  { email: 'compliance@abr-insights.com', role: 'compliance_officer', firstName: 'Compliance', lastName: 'Officer' },
  ...
  { email: 'investigator@abr-insights.com', role: 'investigator', firstName: 'Case', lastName: 'Investigator' },
  { email: 'educator@abr-insights.com', role: 'educator', firstName: 'Training', lastName: 'Educator' },
