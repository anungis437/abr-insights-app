...
async function validateDatabaseState() {
  ...
  try {
    ...
    console.log(
      `✅ Existing Tables: ${existingTables.length}/${Object.keys(expectedTables).length}`
    )
    console.log(
      `❌ Missing Tables: ${missingTables.length}/${Object.keys(expectedTables).length}\n`
    )
    ...
    const migrationTableGroups = {
      '20250115000007_course_workflow': [
        'course_versions',
        'course_reviews',
        'course_workflow_history',
        'content_quality_checklists',
      ],
      '20250115000003_quiz_system': [
        'quizzes',
        'questions',
        'question_options',
        'quiz_attempts',
      ...
      '20250115000008_instructor_portal': [
      ...
      '20250115000010_gamification_points_rewards': [
        'points_transactions',
        'reward_items',
        'user_rewards',
        'leaderboards',
      ...
      '20250116000001_enterprise_sso_auth': [
        'sso_providers',
        'enterprise_sessions',
        'identity_provider_mapping',
        'sso_login_attempts',
      ],
      '20250116000002_advanced_rbac': [
