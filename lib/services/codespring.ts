...
export class CodespringClient {
  ...
  private async makeRequest<T>(
    request: CodespringRequest
  ): Promise<CodespringResponse<T>> {
   ...
   */
  async analyzeCode(code: string, language: string): Promise<CodespringResponse<CodespringAnalysisResult>> {
   ...
   */
  async getAnalysisResult(analysisId: string): Promise<CodespringResponse<CodespringAnalysisResult>> {
    return this.makeRequest<CodespringAnalysisResult>({
      method: 'GET',
