...
const adminCasesContent = `'use client'
...
const dirPath = path.join(process.cwd(), 'app', 'admin', 'cases');
if (!fs.existsSync(dirPath)) {
  fs.mkdirSync(dirPath, { recursive: true });
}

const filePath = path.join(dirPath, 'page.tsx');
fs.writeFileSync(filePath, adminCasesContent, 'utf8');

console.log('Admin cases page written successfully');
